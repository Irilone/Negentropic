...
export const projects: Record<string, ProjectType> = {
  solace: {
    ...
    images: [
      "/entropy-assets/solace-1-onboarding.png",
      "/entropy-assets/solace-2-home.png",
      "/entropy-assets/solace-3-form.png"
    ],
    challenges: [
  ...
  papyrus: {
    ...
    images: [
      "/entropy-assets/papyrus-1-papyrus.png",
      "/entropy-assets/papyrus-2-challenge.png",
      "/entropy-assets/papyrus-3-annotations.png"
    ],
    challenges: [
  ...
  "sos-alarm": {
    ...
    images: [
      "/entropy-assets/sos-1-helpseekercase.png",
      "/entropy-assets/sos-2-gtk.png",
      "/entropy-assets/sos-3-solution.png"
    ],
    challenges: [
